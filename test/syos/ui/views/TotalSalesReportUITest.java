...
class TotalSalesReportUITest {
    ...
    @Nested
    @DisplayName("Generate Report Tests - Happy Path")
    class GenerateReportHappyPathTests {
        @Test
        ...
        void testGenerateReport_SpecificDateRange() {
            ...
            String input = String.format("4\n%s\n%s\n2\n2\n\n", // 4 for specific date range, dates, 2 for online, 2 for
                                                                // COD, Enter for pause
    ...
    @Nested
    @DisplayName("Generate Report Tests - Edge Cases")
    class GenerateReportEdgeCasesTests {
        @Test
        ...
        void testGenerateReport_EmptyItems() {
            ...
            // Act
            totalSalesReportUI.display(); // Assert
            String output = getOutput();
    ...
    @Nested
    @DisplayName("User Input Tests - Invalid Cases")
    class UserInputInvalidCasesTests {
        @Test
        ...
        void testInvalidDateFormat() {
            ...
            String input = "4\ninvalid-date\n2024-01-01\n2024-01-02\n1\n\n"; // 4 for specific range, invalid date, then
                                                                             // valid dates, 1 for in-store, Enter for
                                                                             // pause
            setInput(input);
        ...
        void testInvalidTransactionTypeSelection() {
            // Arrange
            String input = "1\n2\n5\n\n1\n\n"; // Invalid choice 5 for online txn type, Enter for pause, then valid 1,
                                               // Enter for pause
            setInput(input);
    ...
    @Nested
    @DisplayName("Combined Store Type Tests")
    class CombinedStoreTypeTests {
        @Test
    ...
    @Nested
    @DisplayName("Online Store Type Tests")
    class OnlineStoreTypeTests {
        @Test
    ...
    @Nested
    @DisplayName("User Input Tests - Back Options")
    class UserInputBackOptionsTests {
        @Test
        ...
        void testBackOptionTransactionType() {
            // Arrange
            String input = "1\n2\n0\n\n"; // 1 for today, 2 for online, 0 to go back from transaction type, then Enter
                                          // for pause
            setInput(input);
